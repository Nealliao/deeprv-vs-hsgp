...
PRIORS = {
    ...
    "space_length":              dist.InverseGamma(2.0065, 0.1995),    # P[0.25<l<1.80]
...
def run():
    ...
    np.savez_compressed(OUTPUT_DIR / "ecdc_hsgp_v4_enhanced.npz",
    ...
    print(f"[saved] {OUTPUT_DIR / 'ecdc_hsgp_v4_enhanced.npz'}")
    ...
    (OUTPUT_DIR / "ecdc_hsgp_v4_joint9hp_nb.json").write_text(json.dumps(row, indent=2))
    ...
    print(f"\n[saved] {OUTPUT_DIR / 'ecdc_hsgp_v4_joint9hp_nb.json'}")
