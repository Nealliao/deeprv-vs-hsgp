...
MODEL_DIR = Path("/Users/Zhuanz/Desktop/ECDC_measles_HSGP_vs_DeepRV/decoders_final")
...
def run():
    ...
    np.savez_compressed(OUTPUT_DIR / "ecdc_deeprv_v2_enhanced.npz",
    ...
    print(f"[saved] {OUTPUT_DIR / 'ecdc_deeprv_v2_enhanced.npz'}")
    ...
    (OUTPUT_DIR / "ecdc_deeprv_v2_joint9hp_nb.json").write_text(json.dumps(row, indent=2))
    ...
    print(f"\n[saved] {OUTPUT_DIR / 'ecdc_deeprv_v2_joint9hp_nb.json'}")
