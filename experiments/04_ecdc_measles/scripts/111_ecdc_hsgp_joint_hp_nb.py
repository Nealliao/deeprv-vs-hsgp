...
PRIORS = {
    ...
    "space_length":              dist.InverseGamma(6.1091, 3.3175),    # P[0.25<l<1.80]
...
_HP_INIT = {
    "space_alpha": 0.5, "space_length": 0.467,
...
def run():
    ...
    np.savez_compressed(OUTPUT_DIR / "ecdc_hsgp_enhanced.npz",
    ...
    print(f"[saved] {OUTPUT_DIR / 'ecdc_hsgp_enhanced.npz'}")
    ...
    (OUTPUT_DIR / "ecdc_hsgp_joint9hp_nb.json").write_text(json.dumps(row, indent=2))
    ...
    print(f"\n[saved] {OUTPUT_DIR / 'ecdc_hsgp_joint9hp_nb.json'}")
