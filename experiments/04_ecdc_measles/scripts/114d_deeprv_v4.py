...
MODEL_DIR = Path("/Users/Zhuanz/Desktop/ECDC_measles_HSGP_vs_DeepRV/decoders_v3")
...
PRIORS = {
    ...
    "space_length":              dist.InverseGamma(2.0065, 0.1995),
...
_HP_INIT = {
    "space_alpha": 0.5, "space_length": 0.30, "time_alpha": 0.5, "time_length": 22.0,
...
def run():
    ...
    np.savez_compressed(OUTPUT_DIR / "ecdc_deeprv_v4_enhanced.npz",
    ...
    print(f"[saved] {OUTPUT_DIR / 'ecdc_deeprv_v4_enhanced.npz'}")
    ...
    (OUTPUT_DIR / "ecdc_deeprv_v4_joint9hp_nb.json").write_text(json.dumps(row, indent=2))
    ...
    print(f"\n[saved] {OUTPUT_DIR / 'ecdc_deeprv_v4_joint9hp_nb.json'}")
