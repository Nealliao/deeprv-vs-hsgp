...
def run():
    ...
    np.savez_compressed(OUTPUT_DIR / "ecdc_deeprv_enhanced.npz",
    ...
    print(f"[saved] {OUTPUT_DIR / 'ecdc_deeprv_enhanced.npz'}")
    ...
    (OUTPUT_DIR / "ecdc_deeprv_joint9hp_nb.json").write_text(json.dumps(row, indent=2))
    ...
    print(f"\n[saved] {OUTPUT_DIR / 'ecdc_deeprv_joint9hp_nb.json'}")
