...
PRIORS={"space_alpha":dist.HalfNormal(1.0),"space_length":dist.LogUniform(0.030, 1.331),
...
def run():
    ...
    (OUT/"holdout_deeprv_v5.json").write_text(json.dumps(row))
